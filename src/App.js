...
const App = () => {
  const [movies, setMovies] = useState([
    { id: 1, title: 'Kungfu Panda', description: 'Fighting Panda', posterURL: 'kung fu panda.jpg', rating: 8, trailerURL: 'https://youtu.be/kbgf4j9sNZ4?si=wydtE0tYhGgd4g9v' },
    { id: 2, title: 'Ghost Busters', description: 'Busting evil ghost', posterURL: 'Ghost Busters.png', rating: 7, trailerURL: 'https://youtu.be/HpOBXh02rVc?si=YFlTgxi-AoKa2VT4' },
    ...
    { id: 5, title: 'Madame Web', description: 'Spider woman saves the day', posterURL: 'Madae Web.jpg', rating: 8, trailerURL: "https://youtu.be/s_76M4c4LTo?si=cYdSJGymkFgOvBh1"},
    ...
    { id: 7, title: 'Star Wars', description: 'Star Wars the bad batch', posterURL: 'Star Wars.jpg', rating: 3,trailerURL: 'https://youtu.be/Oa5zeHdSwdQ?si=99QEAF8dFUV6QIBN' },
    { id: 8, title: 'Kingdom of The Plantes of Ape', description: 'Ape-dom ', posterURL: 'Kingdom from the planet of apes.jpg', rating: 8, trailerURL: 'https://youtu.be/XtFI7SNtVpY?si=nYN7SPhxyCXipx33'},
